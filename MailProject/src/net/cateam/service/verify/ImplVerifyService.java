 ...
 * 
 */
@WebServiceClient(name = "ImplVerifyService", targetNamespace = "http://webservice/", wsdlLocation = "http://192.168.101.103:9898/verify?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.101.103:9898/verify?wsdl");
